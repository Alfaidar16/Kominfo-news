                    ...
                    <div class="card p-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" class="form-control @error('title') is-invalid
                                 @enderror" placeholder="title" autofocus value="{{ old('title' , $post->title) }}" oninput="generateSlug()">
                              @error('title')
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-2 p-1">
                                ...
                                <select class="form-select @error('category_id') is-invalid @enderror" aria-label="Default select example" name="category_id">
                                    ...
                                    <option value="{{ $key->id }}" {{ old('category_id', $post->category_id) == $key->id ? 'selected' : '' }}>{{ $key->name}}</option>
                                    @endforeach
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <img src="{{ asset('storage/'. $post->image) }}" id="preview" alt="" class="img-fluid mb-2" width="300px">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="created_at" id="created_at" class="form-control" value="{{ $post->created_at }}" >
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group mb-2">
                                ...
                                <textarea class="form-control" name="meta_description"  rows="2"> {{ old('meta_description', $post->meta_description)}}</textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label class="form-label">Meta Keywords</label>
                                <textarea class="form-control" name="meta_keywords" rows="1.5"> {{ old('meta_keywords', $post->meta_keywords )}}</textarea>
                            </div>
                            <div class="form-group mb-2">
                                <label class="form-label">Seo Title</label>
                                <textarea class="form-control" name="seo_title" rows="1">{{ old('seo_title', $post->seo_title) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
