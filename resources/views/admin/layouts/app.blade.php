    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="{{asset('/adminlte/assets/img/logo_kominfo.png')}}" alt="AdminLTE Logo"
                        class="brand-image opacity-75 shadow" />
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">Diskominfo Sulsel</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
        ...
        <footer class="app-footer">
            ...
            <strong>
                ...
                <a href="https://kominfo.sulselprov.go.id/" class="text-decoration-none">Diskominfo Sulsel</a>.
            </strong>
            {{-- All rights reserved. --}}
            <!--end::Copyright-->
        </footer>
