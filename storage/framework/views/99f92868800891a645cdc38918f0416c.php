                ...
                <div class="blog-carousel-wrap">
                    <div class="blog-carousel swiper">
                        <div class="swiper-wrapper swiper-container">
                            <?php $__currentLoopData = getPost('berita-utama', 0,6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                       
                            <div class="swiper-slide">
                                <div class="post-card">
                                    <div class="post-thumb">
                                        
                                         <img src="<?php echo e(asset('storage/'. $post->image)); ?>" alt="<?php echo e($post->title); ?>" style="width: 225px; height:150px;">
                                    ...
                                    <div class="post-content-wrap">
                                        <div class="post-content">
                                            <ul class="post-meta">
                                                <li><i class="fa-light fa-calendar px-2"></i><?php echo e(date('d M Y',strtotime($post->created_at))); ?></li>
                                                
                                            </ul>
                                            <h5 class="">
                                                <a href="<?php echo e(route('post.slug',$post->slug)); ?>"
                                                    ><?php echo \Illuminate\Support\Str::limit($post->title , 100); ?></a
                                                >
                                            </h5>
            ...
            <div class="col-lg-4">
                ...
                <div class="sidebar-widget sticky-widget">
                    <h3 class="widget-title">Berita Terpopuler</h3>
                     <?php $__currentLoopData = getPost('berita-utama',0,3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="col-lg-12 mb-30" style="background-color: rgb(240, 252, 255);">
                ...
                <div class="col-lg-12 col-md-6 pt-20">
                    ...
                    <div class="row side-bar-widget mt-20">
                        <?php $__currentLoopData = $beritaUtama; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="sidebar-post">
                                ...
                                <div class="post-content">
                                    <div class="row d-flex">
                                        <div class="col">
                                            <span><i class="fa-light fa-calendar"></i><?php echo e(\Carbon\Carbon::parse($key->created_at)->format('d-m-Y')); ?></span> 
                                        </div>
                                        <div class="col">
                                            <span class="category rounded-3 p-1 text-white" style="background-color: blue;"><?php echo e($key->name); ?></span>
                                        </div>
                                    </div>
                                    
                                    <h3 class="title text-justify pt-4"><a href="<?php echo e(route('post.slug', $key->slug)); ?>"> <?php echo e($key->title); ?></a></h3>
        ...
        <div class="row mt-25">
            <div class="col-lg-12 mb-30" style="background-color: rgb(240, 252, 255);">
                ...
                <div class="col-lg-12 col-md-6 pt-20">
                    ...
                    <div class="row side-bar-widget mt-20">
                        <?php $__currentLoopData = $opini; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-4 widget-popular-post p-2">
                            <div class="sidebar-post">
                                <img src="<?php echo e(asset('storage/'.$key->image)); ?>" alt="post" style="height: 100px;">
                                <div class="post-content">
                                    <div class="row d-flex">
                                        <div class="col">
                                            <span><i class="fa-light fa-calendar"></i><?php echo e(\Carbon\Carbon::parse($key->created_at)->format('d-m-Y')); ?></span> 
    ...
    <div class="container">
      <div class="swiper mySwiper">
        <div class="swiper-wrapper">
          <?php $__currentLoopData = $featuredVideos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
          <div class="swiper-slide">
             
            <div class="video-item">
              <?php if(!empty($video->video)): ?>
              <a href="<?php echo e(asset('video-kegiatan/'. $video->video)); ?>">
                <iframe src="<?php echo e(asset('video-kegiatan/'. $video->video)); ?>" 
              title="<?php echo e($video->judul); ?>" frameborder="0"
              ...
              <?php endif; ?>
              <h6 class="mt-2 fw-bold text-center"><?php echo e($video->judul); ?></h6>
              <p class="text-muted text-center"><?php echo e(date('d-m-Y', strtotime($video->created_at))); ?></p>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <section class="photo-gallery mb-40">
                    <div class="container">
                        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 gallery-grid">
                            <?php $__currentLoopData = getGaleriKegiatan(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $galleri): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col">
                                <?php
                                $images = json_decode($galleri->images);
                                $firstImage = collect($images)->first(); // Mengambil gambar pertama
                                ?>
                                <a class="gallery-item bg-color bg-white" href="<?php echo e(asset('storage/'.$firstImage)); ?>" data-images="<?php echo e(json_encode($images)); ?>" data-bs-toggle="modal" data-bs-target="#lightbox-modal">
                                    <div class="raflicakep"> 
                                        <img src="<?php echo e(asset('storage/'.$firstImage)); ?>" class="img-fluid rounded-4" alt="Gallery Image">
                                    </div>
                                </a>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <div class="col-lg-12 text-center mt-3" >
                <button class="btn btn-light btn-lg "><a href="<?php echo e(route('galeri.all')); ?>">Lihat Semua Galeri ></a> </button>
            </div>
        </div>
        ...
        <div class="row gy-4">
            <div class="col-lg-3 col-md-6">
                <div class="counter-item wow fade-in-bottom" data-wow-delay="300ms">
                    ...
                    <h3 class="title"><span class="odometer" data-count="<?php echo e($hitstat['total']); ?>"><?php echo e($hitstat['total']); ?></span></h3>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="counter-item wow fade-in-bottom" data-wow-delay="400ms" style="--mt-color-theme-secondary: #f792ff">
                    ...
                    <h3 class="title"><span class="odometer" data-count="<?php echo e($hitstat['month']); ?>"><?php echo e($hitstat['month']); ?></span></h3>
                    <p>Bulan Ini</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="counter-item wow fade-in-bottom" data-wow-delay="500ms" style="--mt-color-theme-secondary: #ff8c91">
                    ...
                    <h3 class="title"><span class="odometer" data-count="<?php echo e($hitstat['today']); ?>"><?php echo e($hitstat['today']); ?></span></h3>
                    <p>Minggu Ini</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 wow fade-in-bottom" data-wow-delay="600ms">
                <div class="counter-item" style="--mt-color-theme-secondary: #a6e155">
                    ...
                    <h3 class="title"><span class="odometer" data-count="<?php echo e(number_format($hitstat['today'])); ?>"><?php echo e(number_format($hitstat['today'])); ?></span></h3>
                    <p>Hari ini</p>
                </div>
            </div>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('guest.layouts.Guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/guest/index.blade.php ENDPATH**/ ?>