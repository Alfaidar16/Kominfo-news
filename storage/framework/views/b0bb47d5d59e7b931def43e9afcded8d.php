        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="page-header-content">
                    <h2 class="text-white"><?php echo e($model->title); ?></h2>
            ...
            <div class="col-lg-8">
                <div class="blog-details-content md-pb-40">
                    <div class="blog-details-thumb">
                        <img class=" rounded-4" src="<?php echo e(asset('storage/'.$model->image)); ?>" alt="blog">
                    </div>
                    <div class="details-meta">
                        <span class="category">Diskominfo-SP Sulsel</span>
                        <p>Admin / <span><?php echo e(date('d M Y',strtotime($model->created_at))); ?></span></p>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('guest.layouts.Guest', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/guest/post.blade.php ENDPATH**/ ?>