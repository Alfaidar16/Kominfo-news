                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="tableInformasi" class="table table-bordered display" width="100%">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $dokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?></td>
                                    <td><?php echo e($key->name); ?></td>
                                    <td><?php echo e($key->title); ?></td>

                                    <td><a href="<?php echo e($key->dokumen ? asset('storage/' . $key->dokumen) : $key->link); ?>"
                                    ...
                                    <td class="d-flex">
                                        ...
                                        <button onclick="hapusInformasi(<?php echo e($key->id); ?>)"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" style="margin-width: 750px;">
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        <form action="<?php echo e(route('informasi_publik.store')); ?>" method="POST"
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="file" name="dokumen" id="dokumen"
                                    class="form-control <?php echo e($errors->has('dokumen') ? 'is-invalid' : ''); ?>">
                                <?php if($errors->has('dokumen')): ?>
                                <div class="invalid-feedback text-danger">
                                    <?php echo e($errors->first('dokumen')); ?>
        ...
        <div class="modal fade" id="editInformasiPublik" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered mw-650px">
                <div class="modal-content rounded">
                    ...
                    <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                        <form action="<?php echo e(route('informasi_publik.update')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<script>
    $(document).ready(function() {
        ...
        function editInformasi(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('informasi_publik.edit')); ?>",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
        ...
        function hapus(id) {
            var _token = "<?php echo e(csrf_token()); ?>";
            $.ajax({
                url: "<?php echo e(route('informasi_publik.destroy')); ?>",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/admin/informasi_publik/index.blade.php ENDPATH**/ ?>