...
unset($__errorArgs, $__bag); ?>" name="slug" id="slug" disabled value="<?php echo e(old('title')); ?>">
               </div>
            <div class="form-group my-3">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group my-3">
                ...
                <input type="date" class="form-control <?php $__errorArgs = ['post_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="post_date" id="post_date">
               </div>
             <div class="row mt-3">
              <div class="col-lg-6">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/admin/kegiatan/create.blade.php ENDPATH**/ ?>