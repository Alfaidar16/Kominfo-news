                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="tablePermohonan" class="table table-bordered display" width="100%">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pengajuanKeberatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr style="background-color: #f2f2f2;">
                                            <td><?php echo e($loop->iteration); ?></td>
                                            <td><?php echo e($d->nama_permohonan); ?></td>
                                            <td><?php echo e($d->tujuan_pemohon); ?></td>
                                            <td><?php echo e($d->alamat); ?></td>
                                            <td><?php echo e($d->nama_kuasa_pemohon); ?></td>
                                            <td><?php echo e($d->no_hp_kuasa_pemohon); ?></td>
                                            <td><?php echo e($d->pekerjaan); ?></td>
                                            <?php
                                                $alasanPengajuan = explode(',', $d->alasan_pengajuan);
                                            ?>
                                            <td>
                                                <?php $__currentLoopData = $alasanPengajuan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $alasan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <ul>
                                                        <li>
                                                            <?php echo e($alasan); ?>
...
<?php $__env->startSection('js'); ?>
    <script>
        ...
        function setuju(id) {
            ...
            $.ajax({
                url: "<?php echo e(route('pengajuan.isSetuju')); ?>",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
        ...
        function tolak(id) {
            var _token = "<?php echo e(csrf_token()); ?>";
            $.ajax({
                url: "<?php echo e(route('Pengajuan.isTolak')); ?>",
                method: "POST",
                data: {
                    _token: _token,
                    id: id
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/admin/Daftar-Formulir/pengajuan_kebaratan.blade.php ENDPATH**/ ?>