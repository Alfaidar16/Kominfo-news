  <nav class="app-header navbar navbar-expand bg-body">
                        ...
                        <li class="nav-item dropdown user-menu">
                            ...
                            >
                                ...
                                <li class="user-header text-bg-primary">
                                    <img
                                        src="<?php echo e(asset('/adminlte/assets/img/user2-160x160.jpg')); ?>"
                ...
                <!--end::Container-->
            </nav><?php /**PATH /Users/lte/Herd/kominfo-new/resources/views/admin/layouts/header.blade.php ENDPATH**/ ?>